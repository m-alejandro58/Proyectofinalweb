      ...
      <div className="w-[200px]">
        ...
        >
          ...
          <SelectContent>
            ...
            <SelectItem value="BANCO (TRANSFERENCIA)">
              Banco (Transferencia)
            </SelectItem>
            <SelectItem value="TARJETA DE CREDITO">Tarjeta Crédito</SelectItem>
            <SelectItem value="FIADO">Sistecredito / Fiado</SelectItem>
          </SelectContent>
        </Select>
      </div>
